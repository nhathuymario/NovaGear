            ...
            <div className="mx-auto grid max-w-[1280px] gap-8 px-4 py-10 md:grid-cols-3 md:px-5">
                ...
                <div>
                    ...
                    <div className="mt-3 space-y-2 text-sm text-slate-600">
                        <Link to="/policies/bao-hanh" className="block hover:text-slate-900">Chính sách bảo hành</Link>
                        <Link to="/policies/giao-hang" className="block hover:text-slate-900">Chính sách giao
                            hàng</Link>
                        <Link to="/policies/thanh-toan" className="block hover:text-slate-900">Hướng dẫn thanh
                            toán</Link>
                        <Link to="/policies/ho-tro" className="block hover:text-slate-900">Liên hệ hỗ trợ 24/7</Link>
                    </div>
                </div>
